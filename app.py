...
def plot_leaderboard(df):
    ...
    fig = px.bar(
        ...
        color_continuous_scale=[(0, "#cfacda"), (1, "#4c0264")],  # Adjusting color scale for visibility
    ...
    fig.update_layout(
        ...
        coloraxis_colorbar=dict(title_font=dict(color="black"), tickfont=dict(color="black")),  # Set color bar title and numbers to black
        xaxis=dict(
            tickangle=-45, 
            showgrid=False,
